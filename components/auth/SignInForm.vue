...
<template>
  <VForm @submit.prevent ref="form" v-model="login_screen.valid">
    ...
    <VTextField
      :rules="login_screen.emailRules"
      label="Email Address"
      v-model="login_screen.email"
      id="email"
      name="email"
      variant="outlined"
      color="primary"
    ...
    <VTextField
      :rules="login_screen.passwordRules"
      label="Password"
      autocomplete="current-password"
      v-model="login_screen.password"
      id="password"
      name="password"
      ...
      @click:append-inner="login_screen.showPassword = !login_screen.showPassword"
      variant="outlined"
      bg-color="neutral"
      color="primary"
      class="elevation-0" />
    ...
    <VBtn
      ...
      type="submit"
      variant="tonal"
      :disabled="!login_screen.valid || userActionDisableButtons"
      >Sign In</VBtn
    >
    <div class="text-right my-4">
      <NuxtLink
        to="/auth/forgotten-password"
        class="font-weight-bold text-primary text-caption"
        >Forgotten your password?</NuxtLink
      >
    </div>
  </VForm>
</template>
